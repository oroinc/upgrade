...
use DT\Bundle\EntityBundle\Model\ExtendOrderErrorCase;
use Oro\Bundle\EntityConfigBundle\Metadata\Annotation\Config;
use Oro\Bundle\EntityConfigBundle\Metadata\Annotation\ConfigField;

/**
 * @ORM\Entity(repositoryClass="DT\Bundle\EntityBundle\Entity\Repository\OrderErrorCaseRepository")
 * @ORM\Table(name="dt_order_error_case")
 * @ORM\HasLifecycleCallbacks()
 * @Config(defaultValues={"dataaudit"={"auditable"=true}})
 */
class OrderErrorCase extends ExtendOrderErrorCase implements DatesAwareInterface
{
    ...
    /**
     * @var Order|null
     * @ORM\ManyToOne(targetEntity="DT\Bundle\EntityBundle\Entity\Order")
     ...
     * @ORM\OneToMany(targetEntity="OrderErrorCaseLineItem", mappedBy="orderErrorCase", cascade={"ALL"}, orphanRemoval=true)
     * @ORM\OrderBy({"id" = "ASC"})
     */
    protected $lineItems;
