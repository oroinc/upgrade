...
/**
 * @see \Oro\Tests\Rector\ExtendedEntityUpdateRector\ExtendedEntityUpdateRectorTest
 */
class ExtendedEntityUpdateRector extends AbstractScopeAwareRector
{
    ...
    public function refactorWithScope(Node $node, Scope $scope)
    {
        ...
        // delete model class
        $this->removedAndAddedFilesCollector->removeFile($parentClassFile);
    ...
    private function moveModelUsesToTheTop(Class_ $modelClassNode): void
    {
        $uses = $this->betterNodeFinder->findInstanceOf(
            $modelClassNode->getAttribute('parent')->stmts,
            Use_::class
        );
    ...
    private function removeParentConstructorCall(Class_ $node): void
    {
        ...
        $this->removeNode($parentConstructorCall);
    }
}
